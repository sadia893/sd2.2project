...
public class EmergencySylhet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_sylhet);
        TextView   original_text = (TextView)findViewById(R.id.original_text7);
        //Load from raw folder

        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.sylhet)));
