...
public class EmergencyKhulna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.khulna1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.khulna2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.khulna3)));
