...
public class EmergencyRajshahi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.rajshahi1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.rajshahi2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.rajshahi3)));
