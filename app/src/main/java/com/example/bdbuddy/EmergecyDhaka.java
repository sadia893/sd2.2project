...
public class EmergecyDhaka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.dhaka1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.dhaka2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.dhaka3)));
