...
public class EmergencyMymensing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.mymensing1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.mymensing2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.mymensing3)));
