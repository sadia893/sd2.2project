...
public class EmergencyBarisal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.barisal1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.barisal2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.barisal3)));
