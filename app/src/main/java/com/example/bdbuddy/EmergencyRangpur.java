...
public class EmergencyRangpur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Scanner data_in = new Scanner((getResources().openRawResource(R.raw.rangpur1)));
        ...
        Scanner data_in1 = new Scanner((getResources().openRawResource(R.raw.rangpur2)));
        ...
        Scanner data_in3 = new Scanner((getResources().openRawResource(R.raw.rangpur3)));
